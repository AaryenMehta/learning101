...
(cl:defmethod timestamp-val ((m <ROSMaster>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader fkie_multimaster_msgs-msg:timestamp-val is deprecated.  Use fkie_multimaster_msgs-msg:timestamp instead.")
  (timestamp m))

(cl:ensure-generic-function 'timestamp_local-val :lambda-list '(m))
(cl:defmethod timestamp_local-val ((m <ROSMaster>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader fkie_multimaster_msgs-msg:timestamp_local-val is deprecated.  Use fkie_multimaster_msgs-msg:timestamp_local instead.")
  (timestamp_local m))
