...
(cl:defmethod cl:initialize-instance :after ((m <ListDescription-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ListDescription-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name fkie_multimaster_msgs-srv:<ListDescription-request> is deprecated: use fkie_multimaster_msgs-srv:ListDescription-request instead.")))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<ListDescription-request>)))
  ...
  "fkie_multimaster_msgs/ListDescriptionRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'ListDescription-request)))
  "Returns string type for a service object of type 'ListDescription-request"
  "fkie_multimaster_msgs/ListDescriptionRequest")
...
(cl:defclass <ListDescription-response> (roslisp-msg-protocol:ros-message)
  ((robot_name
   ...
   (capabilities
    ...
    :type (cl:vector fkie_multimaster_msgs-msg:Capability)
   :initform (cl:make-array 0 :element-type 'fkie_multimaster_msgs-msg:Capability :initial-element (cl:make-instance 'fkie_multimaster_msgs-msg:Capability))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <ListDescription-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ListDescription-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name fkie_multimaster_msgs-srv:<ListDescription-response> is deprecated: use fkie_multimaster_msgs-srv:ListDescription-response instead.")))

(cl:ensure-generic-function 'robot_name-val :lambda-list '(m))
(cl:defmethod robot_name-val ((m <ListDescription-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader fkie_multimaster_msgs-srv:robot_name-val is deprecated.  Use fkie_multimaster_msgs-srv:robot_name instead.")
  (robot_name m))

(cl:ensure-generic-function 'robot_type-val :lambda-list '(m))
(cl:defmethod robot_type-val ((m <ListDescription-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader fkie_multimaster_msgs-srv:robot_type-val is deprecated.  Use fkie_multimaster_msgs-srv:robot_type instead.")
  (robot_type m))

(cl:ensure-generic-function 'robot_images-val :lambda-list '(m))
(cl:defmethod robot_images-val ((m <ListDescription-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader fkie_multimaster_msgs-srv:robot_images-val is deprecated.  Use fkie_multimaster_msgs-srv:robot_images instead.")
  (robot_images m))

(cl:ensure-generic-function 'robot_descr-val :lambda-list '(m))
(cl:defmethod robot_descr-val ((m <ListDescription-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader fkie_multimaster_msgs-srv:robot_descr-val is deprecated.  Use fkie_multimaster_msgs-srv:robot_descr instead.")
  (robot_descr m))

(cl:ensure-generic-function 'capabilities-val :lambda-list '(m))
(cl:defmethod capabilities-val ((m <ListDescription-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader fkie_multimaster_msgs-srv:capabilities-val is deprecated.  Use fkie_multimaster_msgs-srv:capabilities instead.")
  (capabilities m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <ListDescription-response>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'capabilities)))
    (cl:dotimes (i __ros_arr_len)
    (cl:setf (cl:aref vals i) (cl:make-instance 'fkie_multimaster_msgs-msg:Capability))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<ListDescription-response>)))
  ...
  "fkie_multimaster_msgs/ListDescriptionResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'ListDescription-response)))
  "Returns string type for a service object of type 'ListDescription-response"
  "fkie_multimaster_msgs/ListDescriptionResponse")
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<ListDescription-response>)))
  ...
  (cl:format cl:nil "string robot_name~%string robot_type~%string[] robot_images~%string robot_descr~%fkie_multimaster_msgs/Capability[] capabilities~%~%================================================================================~%MSG: fkie_multimaster_msgs/Capability~%# the ROS namespace of the capability~%string namespace~%# the name of the capability~%string name~%# the type of the capability~%string type~%# list of the images assigned to the this capability~%string[] images~%# the description of the capability~%string description~%# a list of nodes assigned to this group. The nodes are described by full ROS name (with namesspace)~%string[] nodes ~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'ListDescription-response)))
  "Returns full string definition for message of type 'ListDescription-response"
  (cl:format cl:nil "string robot_name~%string robot_type~%string[] robot_images~%string robot_descr~%fkie_multimaster_msgs/Capability[] capabilities~%~%================================================================================~%MSG: fkie_multimaster_msgs/Capability~%# the ROS namespace of the capability~%string namespace~%# the name of the capability~%string name~%# the type of the capability~%string type~%# list of the images assigned to the this capability~%string[] images~%# the description of the capability~%string description~%# a list of nodes assigned to this group. The nodes are described by full ROS name (with namesspace)~%string[] nodes ~%~%"))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'ListDescription)))
  ...
  "fkie_multimaster_msgs/ListDescription")