...
(cl:defmethod cl:initialize-instance :after ((m <Capability>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Capability)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name fkie_multimaster_msgs-msg:<Capability> is deprecated: use fkie_multimaster_msgs-msg:Capability instead.")))

(cl:ensure-generic-function 'namespace-val :lambda-list '(m))
(cl:defmethod namespace-val ((m <Capability>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader fkie_multimaster_msgs-msg:namespace-val is deprecated.  Use fkie_multimaster_msgs-msg:namespace instead.")
  (namespace m))
...
(cl:defmethod type-val ((m <Capability>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader fkie_multimaster_msgs-msg:type-val is deprecated.  Use fkie_multimaster_msgs-msg:type instead.")
  (type m))

(cl:ensure-generic-function 'images-val :lambda-list '(m))
(cl:defmethod images-val ((m <Capability>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader fkie_multimaster_msgs-msg:images-val is deprecated.  Use fkie_multimaster_msgs-msg:images instead.")
  (images m))

(cl:ensure-generic-function 'description-val :lambda-list '(m))
(cl:defmethod description-val ((m <Capability>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader fkie_multimaster_msgs-msg:description-val is deprecated.  Use fkie_multimaster_msgs-msg:description instead.")
  (description m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<Capability>)))
  ...
  "fkie_multimaster_msgs/Capability")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'Capability)))
  "Returns string type for a message object of type 'Capability"
  "fkie_multimaster_msgs/Capability")
