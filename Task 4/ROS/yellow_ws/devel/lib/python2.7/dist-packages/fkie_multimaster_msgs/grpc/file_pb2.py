...
GetFileContentRequest = _reflection.GeneratedProtocolMessageType('GetFileContentRequest', (_message.Message,), {
...
GetFileContentReply = _reflection.GeneratedProtocolMessageType('GetFileContentReply', (_message.Message,), {
...
SaveFileContentRequest = _reflection.GeneratedProtocolMessageType('SaveFileContentRequest', (_message.Message,), {
...
SaveFileContentReply = _reflection.GeneratedProtocolMessageType('SaveFileContentReply', (_message.Message,), {
...
CopyToRequest = _reflection.GeneratedProtocolMessageType('CopyToRequest', (_message.Message,), {
...
FileChunkAck = _reflection.GeneratedProtocolMessageType('FileChunkAck', (_message.Message,), {
...
PathList = _reflection.GeneratedProtocolMessageType('PathList', (_message.Message,), {
...
PathObj = _reflection.GeneratedProtocolMessageType('PathObj', (_message.Message,), {
  'DESCRIPTOR' : _PATHOBJ,
  '__module__' : 'file_pb2'
...
ListPackagesReply = _reflection.GeneratedProtocolMessageType('ListPackagesReply', (_message.Message,), {
...
PackageObj = _reflection.GeneratedProtocolMessageType('PackageObj', (_message.Message,), {
