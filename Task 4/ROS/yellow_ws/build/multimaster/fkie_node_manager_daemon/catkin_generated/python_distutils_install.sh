...
echo_and_run cd "/home/aaryen/yellow_ws/src/multimaster/fkie_node_manager_daemon"
...
echo_and_run /usr/bin/env \
    ...
    build --build-base "/home/aaryen/yellow_ws/build/multimaster/fkie_node_manager_daemon" \
    install \
    $DESTDIR_ARG \
